...
export const addVolunteers = async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
...
export const getvolonteersById = async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
...
export const editvolunteers = async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
    ...
    const editedvolunteer = await Volunteer.findByIdAndUpdate(
        id,
        editedDetailes,
        { new: true }
    );
...
export const deleteVolunteers = async (
    req: Request,
    res: Response,
    next: NextFunction
) => {
    const { id } = req.params;
    const deletedvolunteer = await Volunteer.findByIdAndUpdate(
        id,
        { isDeleted: true },
        { new: true }
    );
